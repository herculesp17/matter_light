...
extern "C" void app_main()
{
    ...
    // esp_rom_gpio_pad_select_gpio((gpio_num_t)CONFIG_EXAMPLE_LED_GPIO);
    ...
    // endpoint handles can be used to add/modify clusters. first LED
     ...
     * default values are set during init*/ 
